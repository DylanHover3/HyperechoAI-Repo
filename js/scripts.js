                          ...
                          (t.onload = function () {
                            !(function (e) {
                              var t = e.width,
                                ...
                                r =
                                  y.pageYOffset ||
                                  v.documentElement.scrollTop ||
                                  0,
                                i =
                                  y.pageXOffset ||
                                  v.documentElement.scrollLeft ||
                                  0,
                              ...
                              (function () {
                                w.target.classList.add("lightense-open"),
                                  ...
                                  w.target.parentNode.insertBefore(
                                    w.wrap,
                                    w.target
                                  ),
            ...
            function o(e, t) {
              ...
              (r.id = e),
                r.styleSheet
                  ...
                  : r.appendChild(v.createTextNode(t)),
                n.appendChild(r);
            }
            function a() {
              r("beforeHide"),
...
/* Custom Hero Button Functionality
   ====================================================
   Smooth scroll functionality for "Get a Quote" button
   ==================================================== */

document.addEventListener("DOMContentLoaded", function () {
  // Smooth scroll to quote form
  const quoteButton = document.querySelector(".scroll-to-quote");

  if (quoteButton) {
    quoteButton.addEventListener("click", function (e) {
      e.preventDefault();

      // Find the quote form section and scroll to its top
